...
Generate harmonious color palettes and copy hex codes instantly for web and app design.

## Domain-friendly Name
- Project slug: `palettekit`
- Suggested domain: `palettekit.web.app` or `palettekit.com`
...
- URL: `http://localhost:8101/index.html`
...
3. Initialize project if needed: `firebase use palettekit-nh2672`
